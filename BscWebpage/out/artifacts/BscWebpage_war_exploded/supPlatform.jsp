...
<form method = "post" action = "${pageContext.request.contextPath}/SupReport">
    <button type = 'submit' value = 'Show my Students' >Show my Students</button>
</form>
